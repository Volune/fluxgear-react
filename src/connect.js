  ...
  return (WrappedComponent) => {
    class ConnectedComponent extends Component {
      constructor(props, context) {
        super(props, context);
        this.engine = props[ENGINE_KEY] || context[ENGINE_KEY];
    ...
    ConnectedComponent.displayName = `FluxGearConnected(${getDisplayName(WrappedComponent)})`;
    ...
    ConnectedComponent.childContextTypes = WrappedComponent.childContextTypes;
